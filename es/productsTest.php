...
<html lang="en">
    <head>
        ...
        <?php
          ...
          require('../sadmin/sadmin/php/products.php');
    ...
    <body>
        ...
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="index.html"><img src="../img/logo.png" class="brandImg" alt=""></a>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <pPoder Máximo (pmax): <strong>260W</strong></p>
                                            <p>Material: <strong>Silicio</strong></p>
                                            <p>AM = <strong>1.5</strong></p>
                                            <p>Estándares Internacionales de Cálidad.</p>
                                        </div>
                                ...
                                <img class="d-block w-100" src="../img/products/panel2/panel2.1.jpg" alt="First slide">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <pPoder Máximo (pmax): <strong>150W</strong></p>
                                            <p>Material: <strong>Silicio</strong></p>
                                            <p>AM = <strong>1.5</strong></p>
                                            <p>Estándares Internacionales de Cálidad.</p>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p>Voltaje: <strong>17.5V</strong></p>
                                            <pPoder Máximo (pmax): <strong>80W</strong></p>
                                            <p>Material: <strong>Silicio</strong></p>
                                            <p>AM = <strong>1.5</strong></p>
                                            <p>Estándares Internacionales de Cálidad.</p>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p>Voltaje: <strong>17.5V</strong></p>
                                            <pPoder Máximo (pmax): <strong>70W</strong></p>
                                            <p>Material: <strong>Silicio</strong></p>
                                            <p>AM = <strong>1.5</strong></p>
                                            <p>Estándares Internacionales de Cálidad.</p>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p>Voltaje: <strong>17.5V</strong></p>
                                            <pPoder Máximo (pmax): <strong>60W</strong></p>
                                            <p>Material: <strong>Silicio</strong></p>
                                            <p>AM = <strong>1.5</strong></p>
                                            <p>Estándares Internacionales de Cálidad.</p>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p>Voltaje: <strong>17.5V</strong></p>
                                            <pPoder Máximo (pmax): <strong>40W</strong></p>
                                            <p>Material: <strong>Silicio</strong></p>
                                            <p>AM = <strong>1.5</strong></p>
                                            <p>Estándares Internacionales de Cálidad.</p>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p>Voltaje: <strong>17.5V</strong></p>
                                            <pPoder Máximo (pmax): <strong>20W</strong></p>
                                            <p>Material: <strong>Silicio</strong></p>
                                            <p>AM = <strong>1.5</strong></p>
                                            <p>Estándares Internacionales de Cálidad.</p>
                                        </div>
