        ...
        <section class="portfolio_area">
            ...
            <div class="ms_portfolio_inner">
                ...
                <div class="col-md-3 col-sm-12 ms_p_item brand arc panels">
                    <?php $testUrl2 = "panel0.11.jpg"; ?>
                    <img src="../img/products/panel0/<?php echo $testUrl2 ?>" alt="">
                    <div class="center_c">

                        <h3>Panel solar Test</h3>
                ...
                <div class="modal fade" id="panel0" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="firstPanelTitle">Panel solar Test |Tecnología Alemana</h5>
                        ...
                        <div class="modal-body">
                          <?php
                            $testURL = "<img class='d-block w-100' src='../img/products/panel0/panel0.11.jpg' alt='First slide'>";
                            print $testURL;
                            $testUrl2 = "panel0.11.jpg";
                          ?>
                        <img class="d-block w-100" src="../img/products/panel0/<?php print $testUrl2 ?>" alt="First slide">
                            <div class="row">
                                <div class="col-md-8">
